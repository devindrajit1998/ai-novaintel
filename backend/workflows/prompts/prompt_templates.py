...
Output:
{
    "rfp_summary": "The client requires a cloud-based CRM solution to improve customer relationship management and achieve 30% sales growth...",
    "context_overview": "The organization is looking to modernize their customer management processes...",
    "business_objectives": [
        "Increase sales by 30%",
        "Improve customer relationship management",
        "Migrate to cloud-based infrastructure"
    ],
    "project_scope": "Implementation of a comprehensive cloud CRM system including integration with existing systems..."
}
...
Output:
{
    "rfp_summary": "The banking institution requires digital transformation of legacy systems with stringent uptime requirements...",
    "context_overview": "Financial services organization needs to modernize aging infrastructure...",
    "business_objectives": [
        "Maintain 99.9% system uptime",
        "Modernize legacy banking systems",
        "Ensure regulatory compliance"
    ],
    "project_scope": "Complete digital transformation including migration, integration, and compliance verification..."
}
"""
...
Output:
{
    "challenges": [
        ...
        {
            "challenge": "Legacy systems limiting scalability and integration",
            "type": "Technical",
            "impact": "High",
            "category": "Technology Infrastructure"
        },
        {
            "challenge": "Regulatory compliance requirements increasing complexity",
            "type": "Compliance",
            "impact": "Medium",
...
{
    "value_propositions": [
        "Automated workflow reduces processing time by 60% and eliminates manual errors",
        "Modern cloud architecture enables 99.9% uptime and seamless integration",
        "Built-in compliance framework reduces audit preparation time by 50%",
        "Scalable platform supports 3x growth without infrastructure investment",
        "Real-time analytics provide actionable insights within 24 hours"
    ]
}
"""
...
PROPOSAL_BUILDER_COT = get_chain_of_thought_prompt(
    ...
    [
        ...
        "Structure executive summary to highlight key value",
        "Demonstrate understanding of client challenges",
        "Present solution that directly addresses each challenge",
        "Quantify benefits using value propositions",
        "Support claims with relevant case studies",
        "Detail implementation approach with clear milestones"
    ]
)
...
def get_few_shot_rfp_analyzer_prompt() -> str:
    ...
    return f"""You are an expert RFP analyst. Analyze the RFP document and extract:
...
def get_few_shot_challenge_extractor_prompt() -> str:
    ...
    return f"""You are an expert at identifying business and technical challenges from RFP documents.
...
def get_few_shot_value_proposition_prompt() -> str:
    ...
    return f"""You are an expert at crafting compelling value propositions for presales.
...
def get_few_shot_discovery_question_prompt() -> str:
    ...
    return f"""You are an expert at creating discovery questions for presales engagements.
...
def get_few_shot_proposal_builder_prompt() -> str:
    ...
    return f"""You are an expert proposal writer. Create a comprehensive proposal draft.
